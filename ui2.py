...
class TabBar(Frame):
    ...
    def update_W_Data(self):
        while (True):
            ...
            logData.logTemps(self.setTemp, self.curTemp, weather.outside_temp, weather.get_High(), weather.get_Low(), weather.get_Humidity(), weather.get_Wind(), True)
    pass

    def Increase_Tempature(self):
        self.setTemp += 1
        self.display_HT.set(self.setTemp)
    pass
    ...
    def init_UI(self, root):
        ...
        label_SetTemp = tk.Label(frame_1, textvariable=self.display_HT, font=("Helvetica", 16), fg="orange")
